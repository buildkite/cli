...
// ListAgentsOrganization includes the requested fields of the GraphQL type Organization.
// The GraphQL type's documentation follows.
//
// An organization
type ListAgentsOrganization struct {
	Agents *ListAgentsOrganizationAgentsAgentConnection `json:"agents"`
}

// GetAgents returns ListAgentsOrganization.Agents, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganization) GetAgents() *ListAgentsOrganizationAgentsAgentConnection {
	return v.Agents
}

// ListAgentsOrganizationAgentsAgentConnection includes the requested fields of the GraphQL type AgentConnection.
type ListAgentsOrganizationAgentsAgentConnection struct {
	Edges    []*ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge `json:"edges"`
	PageInfo *ListAgentsOrganizationAgentsAgentConnectionPageInfo         `json:"pageInfo"`
}

// GetEdges returns ListAgentsOrganizationAgentsAgentConnection.Edges, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnection) GetEdges() []*ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge {
	return v.Edges
}

// GetPageInfo returns ListAgentsOrganizationAgentsAgentConnection.PageInfo, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnection) GetPageInfo() *ListAgentsOrganizationAgentsAgentConnectionPageInfo {
	return v.PageInfo
}

// ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge includes the requested fields of the GraphQL type AgentEdge.
type ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge struct {
	Node *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent `json:"node"`
}

// GetNode returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge.Node, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdge) GetNode() *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent {
	return v.Node
}

// ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent includes the requested fields of the GraphQL type Agent.
// The GraphQL type's documentation follows.
//
// An agent
type ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent struct {
	Id string `json:"id"`
	// The name of the agent
	Name string `json:"name"`
	// The hostname of the machine running the agent
	...
	IsRunningJob bool `json:"isRunningJob"`
	// Whether this agent is paused, preventing dispatch of new jobs
	Paused bool `json:"paused"`
	// Whether this agent is paused, preventing dispatch of new jobs
	PausedAt *time.Time `json:"pausedAt"`
	// The user who paused this agent, if paused
	PausedBy *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser `json:"pausedBy"`
	// Note supplied when agent was paused, if paused
	PausedNote *string `json:"pausedNote"`
	// Number of minutes the agent will remain paused for, if paused
	PausedTimeoutInMinutes int                                                                             `json:"pausedTimeoutInMinutes"`
	ClusterQueue           *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue `json:"clusterQueue"`
}

// GetId returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.Id, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetId() string {
	return v.Id
}

// GetName returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.Name, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetName() string {
	return v.Name
}

// GetHostname returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.Hostname, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetHostname() *string {
	return v.Hostname
}

// GetVersion returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.Version, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetVersion() *string {
	return v.Version
}

// GetConnectionState returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.ConnectionState, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetConnectionState() string {
	return v.ConnectionState
}

// GetMetaData returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.MetaData, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetMetaData() []string {
	return v.MetaData
}

// GetCreatedAt returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.CreatedAt, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetCreatedAt() *time.Time {
	return v.CreatedAt
}

// GetIpAddress returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.IpAddress, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetIpAddress() *string {
	return v.IpAddress
}

// GetUserAgent returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.UserAgent, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetUserAgent() *string {
	return v.UserAgent
}

// GetIsRunningJob returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.IsRunningJob, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetIsRunningJob() bool {
	return v.IsRunningJob
}

// GetPaused returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.Paused, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetPaused() bool {
	return v.Paused
}

// GetPausedAt returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.PausedAt, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetPausedAt() *time.Time {
	return v.PausedAt
}

// GetPausedBy returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.PausedBy, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetPausedBy() *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser {
	return v.PausedBy
}

// GetPausedNote returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.PausedNote, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetPausedNote() *string {
	return v.PausedNote
}

// GetPausedTimeoutInMinutes returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.PausedTimeoutInMinutes, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetPausedTimeoutInMinutes() int {
	return v.PausedTimeoutInMinutes
}

// GetClusterQueue returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent.ClusterQueue, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgent) GetClusterQueue() *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue {
	return v.ClusterQueue
}

// ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue includes the requested fields of the GraphQL type ClusterQueue.
type ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue struct {
	Id  string `json:"id"`
	Key string `json:"key"`
}

// GetId returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue.Id, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue) GetId() string {
	return v.Id
}

// GetKey returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue.Key, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentClusterQueue) GetKey() string {
	return v.Key
}

// ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser includes the requested fields of the GraphQL type User.
// The GraphQL type's documentation follows.
//
// A user
type ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser struct {
	// The name of the user
	Name string `json:"name"`
}

// GetName returns ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser.Name, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionEdgesAgentEdgeNodeAgentPausedByUser) GetName() string {
	return v.Name
}

// ListAgentsOrganizationAgentsAgentConnectionPageInfo includes the requested fields of the GraphQL type PageInfo.
// The GraphQL type's documentation follows.
//
// Information about pagination in a connection.
type ListAgentsOrganizationAgentsAgentConnectionPageInfo struct {
	// When paginating forwards, are there more items?
	HasNextPage bool `json:"hasNextPage"`
	// When paginating forwards, the cursor to continue.
	EndCursor *string `json:"endCursor"`
...
// GetHasNextPage returns ListAgentsOrganizationAgentsAgentConnectionPageInfo.HasNextPage, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionPageInfo) GetHasNextPage() bool {
	return v.HasNextPage
}

// GetEndCursor returns ListAgentsOrganizationAgentsAgentConnectionPageInfo.EndCursor, and is useful for accessing the field via an interface.
func (v *ListAgentsOrganizationAgentsAgentConnectionPageInfo) GetEndCursor() *string {
	return v.EndCursor
}

// ListAgentsResponse is returned by ListAgents on success.
type ListAgentsResponse struct {
	// Find an organization
	Organization *ListAgentsOrganization `json:"organization"`
}

// GetOrganization returns ListAgentsResponse.Organization, and is useful for accessing the field via an interface.
func (v *ListAgentsResponse) GetOrganization() *ListAgentsOrganization { return v.Organization }
...
// __ListAgentsInput is used internally by genqlient
type __ListAgentsInput struct {
	OrgSlug      string  `json:"orgSlug"`
...
// GetOrgSlug returns __ListAgentsInput.OrgSlug, and is useful for accessing the field via an interface.
func (v *__ListAgentsInput) GetOrgSlug() string { return v.OrgSlug }

// GetFirst returns __ListAgentsInput.First, and is useful for accessing the field via an interface.
func (v *__ListAgentsInput) GetFirst() *int { return v.First }

// GetAfter returns __ListAgentsInput.After, and is useful for accessing the field via an interface.
func (v *__ListAgentsInput) GetAfter() *string { return v.After }

// GetIsRunningJob returns __ListAgentsInput.IsRunningJob, and is useful for accessing the field via an interface.
func (v *__ListAgentsInput) GetIsRunningJob() *bool { return v.IsRunningJob }

// GetPaused returns __ListAgentsInput.Paused, and is useful for accessing the field via an interface.
func (v *__ListAgentsInput) GetPaused() *bool { return v.Paused }
...
// The query executed by ListAgents.
const ListAgents_Operation = `
...
func ListAgents(
	...
	isRunningJob *bool,
	paused *bool,
) (data_ *ListAgentsResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "ListAgents",
		Query:  ListAgents_Operation,
		Variables: &__ListAgentsInput{
			OrgSlug:      orgSlug,
			First:        first,
			After:        after,
